...
class Articulo(models.Model):
    ...
    art_img2 = models.ImageField(upload_to='articulos/', blank=True, null=True)
    art_img3 = models.ImageField(upload_to='articulos/', blank=True, null=True)
...
class Vendedor(models.Model):
    ...
    ven_emai = models.EmailField(blank=True, null=True) #le puse null a emaill
